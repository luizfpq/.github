...
### 🛠️ Tecnologias e Interesses
  ...
  * **Inteligência Artificial:** Pesquisa em NLP (Processamento de Linguagem Natural), LLMs e como aplicar modelos de linguagem para resolver problemas complexos do mundo real.
  * **Infraestrutura & Homelab:** Administro o cluster **ironmox** (Proxmox/Debian), explorando virtualização, containers e automação de redes com foco em alta performance e soberania digital.
  * **Desenvolvimento:** Python para automação e análise de dados, além de JavaScript para ferramentas web práticas.
  * **Educação Tech:** Criação de materiais didáticos, slides e labs práticos para simplificar temas como criptografia e segurança da informação.
...
*“Ensinar é a melhor forma de aprender duas vezes.”*
